...
def Deploy_8(request): 
    ...
    if request.method == "POST":
        ...
        models = keras.models.load_model('C:/Users/lap/Music/FETAL HEALTH/CODING/Deploy/Project/App/keras_model.h5')
        data = np.ndarray(shape=(1, 224, 224, 3), dtype=np.float32)
        image = Image.open("C:/Users/lap/Music/FETAL HEALTH/CODING/Deploy/Project/media/" + str(result1)).convert("RGB")
        size = (224, 224)
...
Model = joblib.load('C:/Users/lap/Music/FETAL HEALTH/CODING/Deploy/Project/App/FETAL1.pkl')
